# Codes for text encoder and progressive denoising decoder 
import torch 
...
class Embeddings(nn.Module):
    """Construct the embeddings from word/image/music and position."""
...
class PriorModel(PreTrainedModel): 
...
class PDGModel(PriorModel): 
    def __init__(self, text_config, image_config): 
        super(PDGModel, self).__init__(text_config)
    ...
    def forward(
        ...
        text_hidden_states = self.text_model(input_ids=text_ids, attention_mask=text_attention_mask)[0] 
